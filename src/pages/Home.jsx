    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 pt-36 pb-24 relative z-20">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-12">
          <div>
            <div className="text-[10px] text-amber-500 font-mono font-bold tracking-widest uppercase mb-1">
              MEMBER CONSOLE
            </div>
            <h2 className="text-4xl font-black tracking-tight text-white">Your Travel Dashboard</h2>
          </div>
          <ShimmerButton className="!px-6 !py-2.5 !text-xs !rounded-full">
            Launch AI Planner
          </ShimmerButton>
        </div>
        ...
        <AsymmetricBento>
          ...
          <AsymmetricBentoItem
            colSpan={4}
            className="min-h-[260px] p-8 flex flex-col relative group overflow-hidden border-t border-t-amber-500/50 glass-panel glass-panel-hover"
          >
            <img
            ...
            <div className="relative z-10 flex flex-col h-full">
              ...
              <div className="text-xs font-bold text-amber-400 mb-auto tracking-wide">
                Elite Miles Available
              </div>
          ...
          <AsymmetricBentoItem
            colSpan={8}
            className="min-h-[260px] p-8 flex flex-col justify-end relative group glass-panel"
          >
            <img
            ...
            <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
              <div>
                ...
                <div className="text-xs text-slate-300 font-bold tracking-wide">
                  First Class • Suite 42A • Tokyo Haneda
                </div>
              </div>
          ...
          <WeatherTelemetryWidget
            colSpan={4}
            className="glass-panel glass-panel-hover border border-white/5"
          />

          {/* Jet Charter Option (Spans 4) */}
          <AsymmetricBentoItem
            colSpan={4}
            className="min-h-[260px] p-6 flex flex-col justify-between relative group overflow-hidden glass-panel glass-panel-hover border border-white/5"
          >
            <img
            ...
            <div className="relative z-10 flex flex-col justify-between h-full">
              <div>
                ...
                <p className="text-xs text-slate-400 mt-2 leading-relaxed">
                  Instantly book private jet routes with direct runway boarding and concierge
                  transfers.
                </p>
              </div>
              <div className="flex items-center justify-between mt-4">
                <span className="text-[10px] text-[#ff6b6b] font-mono font-bold tracking-widest uppercase">
                  GLOBAL NETWORK
                </span>
          ...
          >
            ...
            <div className="relative z-10 flex flex-col justify-between h-full">
              <div>
                ...
                <p className="text-xs text-slate-400 mt-2 leading-relaxed">
                  24/7 personal assistants for restaurant bookings, entry clearance, and security
                  escort.
                </p>
              </div>
              <div className="flex items-center justify-between mt-4">
      ...
      <div className="max-w-7xl mx-auto px-6 pb-24 relative z-20">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
          <div>
            <div className="text-[10px] text-emerald-500 font-mono font-bold tracking-widest uppercase mb-1">
              CURATED LOCATIONS
            </div>
