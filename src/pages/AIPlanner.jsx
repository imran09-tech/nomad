      ...
      <div className="max-w-4xl mx-auto space-y-12">
        <div className="text-center">
          ...
          <p className="text-slate-400 font-medium tracking-wide">
            Enter your parameters. The intelligence constructs the perfect odyssey.
          </p>
        </div>
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-[#020408] shadow-inner text-white rounded-2xl pl-12 pr-4 py-5 font-bold tracking-wide focus:outline-none focus:ring-2 focus:ring-pink-500/50 border border-slate-800/60 transition-all"
                  />
                </div>
                <div className="relative">
              ...
              <div className="flex justify-center">
                <ShimmerButton
                  ...
                  className="!w-full md:!w-auto !px-16 !py-5 bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 text-white shadow-[0_0_20px_rgba(236,72,153,0.3)]"
                >
            ...
            >
              ...
              <div className="flex justify-between items-end mb-4">
                ...
                <div className="text-right">
                  ...
                  <div className="text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-indigo-400">
                    $11,850
                  </div>
                </div>
              </div>
              ...
              <div className="relative border-l-2 border-dashed border-slate-800/80 ml-6 pl-10 space-y-12">
                ...
                <div className="relative group">
                  ...
                  <div className="text-[10px] text-indigo-400 font-mono font-bold tracking-widest uppercase mb-1">
                    Day 1 • Arrival
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="bg-[#080c14] border border-slate-800/60 p-4 rounded-2xl flex items-center space-x-4 transition-colors hover:border-slate-700">
                      <div className="w-12 h-12 rounded-xl bg-slate-800 overflow-hidden">
                        <img
                          src="https://images.unsplash.com/photo-1542314831-c6a4d14d8c85?q=80&w=100"
                          className="w-full h-full object-cover"
                        />
                      </div>
                      <div>
                        <div className="text-white font-bold tracking-wide">Suite Check-in</div>
                        <div className="text-xs text-slate-500 font-mono tracking-widest mt-1 uppercase">
                          14:00
                        </div>
                      </div>
                    </div>
                ...
                <div className="relative group">
                  ...
                  <div className="text-[10px] text-pink-400 font-mono font-bold tracking-widest uppercase mb-1">
                    Day 2 • Culture
                  </div>
                  <h4 className="text-2xl font-black text-white mb-4">
                    Private Kinkaku-ji Viewing
                  </h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="bg-[#080c14] border border-slate-800/60 p-4 rounded-2xl flex items-center space-x-4 transition-colors hover:border-slate-700">
