      ...
      >
        <div>
          ...
          <p style={{ color: 'var(--text-secondary)' }}>
            Curated experiences for the elite traveler.
          </p>
        </div>
      ...
      >
        {(destinations
          ? destinations.filter((item, index, self) => {
              ...
              const cleanImg = String(item.img)
                .replace(/^(\.\.\/|\.\/)+/, '')
                .toLowerCase()
                .split('?')[0]
                .trim();
          ...
          >
            <div style={{ height: '200px', width: '100%', position: 'relative' }}>
              ...
              <button
                onClick={(e) => {
                  e.stopPropagation(); /* toggle favorite */
                }}
                style={{
                  position: 'absolute',
                  top: '12px',
