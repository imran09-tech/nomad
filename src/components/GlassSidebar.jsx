...
import { 
  Home, Plane, Building2, 
  Map, Sparkles, Wallet, User, ChevronRight, MessageSquare
} from 'lucide-react';
    ...
    >
      ...
      >
          ...
          <AnimatePresence>
            {isHovered && (
              ...
              >
                ...
                <span className="text-amber-500 font-bold tracking-widest text-xs uppercase block -mt-1">Premium</span>
              </motion.div>
            )}
          </AnimatePresence>
        </div>
            ...
            >
              {({ isActive }) => (
                <>
                  ...
                  <div className={`shrink-0 w-8 flex justify-center transition-transform duration-300 ${isActive ? 'scale-110' : 'group-hover:scale-110'}`}>
        ...
        <div className="px-5 mt-auto relative z-10 flex items-center justify-center cursor-pointer">
           <div className={`w-10 h-10 rounded-full border border-slate-700 bg-[#020408] overflow-hidden hover:border-amber-500 transition-colors shrink-0`}>
             ...
             {isHovered && (
                ...
                >
                  <div className="flex flex-col whitespace-nowrap">
                     ...
                     <span className="text-[10px] font-mono tracking-widest uppercase text-amber-500">Elite Tier</span>
                  </div>
