    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <i
              ...
              style={{ color: '#bbb', marginBottom: '8px', display: 'block' }}
            ></i>
        ...
        <p style={{ color: '#ccc', lineHeight: 1.6, fontSize: '14px', marginBottom: '32px' }}>
          {selectedItem.desc ||
            'Experience the ultimate luxury escape. Enjoy pristine beaches, world-class dining, and exclusive amenities tailored to elite travelers.'}
        </p>
        ...
        >
          ...
          >
            ...
            <span style={{ color: 'var(--gold)' }}>
              ${(selectedItem.price * 1.1).toLocaleString()}
            </span>
          </div>
        </div>
      </div>
