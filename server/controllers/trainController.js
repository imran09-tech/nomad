...
exports.getStationSuggestions = async (req, res, next) => {
  try {
    ...
    try {
      ...
      console.warn(
        'RapidAPI searchStation request failed. Using local suggestions fallback.',
        apiError.message
      );
    }
...
exports.getLiveStationTrains = async (req, res, next) => {
  try {
    ...
    const options = {
      ...
      headers: {
        'x-rapidapi-key':
          process.env.RAPIDAPI_IRCTC_KEY || 'c7cc2a9bc8msh381725ff4f06cbep1aada9jsncb9bf40cfadc',
        'x-rapidapi-host': 'irctc1.p.rapidapi.com',
        'Content-Type': 'application/json',
      },
    };
...
exports.getTrainsBetweenStations = async (req, res, next) => {
  try {
    ...
    const options = {
      ...
      headers: {
        'x-rapidapi-key':
          ...
          'c7cc2a9bc8msh381725ff4f06cbep1aada9jsncb9bf40cfadc',
        'x-rapidapi-host': 'irctc1.p.rapidapi.com',
        'Content-Type': 'application/json',
      },
    };
    ...
    try {
      ...
      console.warn(
        'RapidAPI trainBetweenStations request failed. Using local fallback.',
        apiError.message
      );
    }
    ...
    const fromStation = allStations.find((s) => s.code.toUpperCase() === fromCode) || {
      name: fromCode,
    };
    ...
    const predefRoutes = {
      'BGP-ANVT': [
        ...
        {
          id: '22405',
          name: 'Anand Vihar Garib Rath Express',
          dep: '13:55',
          arr: '08:50',
          duration: '18h 55m',
          platform: 'PF 3',
        ...
        {
          id: '20501',
          name: 'Agartala Tejas Rajdhani Express',
          dep: '18:30',
          arr: '10:55',
          duration: '16h 25m',
          platform: 'PF 1',
        ...
        {
          id: '14003',
          name: 'Malda Town - Anand Vihar Express',
          dep: '10:00',
          arr: '08:30',
          duration: '22h 30m',
          platform: 'PF 2',
      ...
      'HWH-NDLS': [
        ...
        {
          id: '12305',
          name: 'Howrah Rajdhani Express (via Patna)',
          dep: '14:05',
          arr: '08:30',
          duration: '18h 25m',
          platform: 'PF 8',
    ...
    if (!routeTrains) {
      routeTrains = [
        {
          id: '12401',
          name: `${fromShort} - ${toShort} Superfast Express`,
          dep: '06:00',
          arr: '18:30',
          duration: '12h 30m',
          platform: 'PF 1',
        ...
        {
          id: '12403',
          name: `${fromShort} - ${toShort} Humsafar Express`,
          dep: '14:20',
          arr: '04:50',
          duration: '14h 30m',
          platform: 'PF 2',
        ...
        {
          id: '12405',
          name: `${fromShort} - ${toShort} Shatabdi Express`,
          dep: '07:15',
          arr: '15:45',
          duration: '8h 30m',
          platform: 'PF 1',
        ...
        {
          id: '22407',
          name: `${fromShort} - ${toShort} Garib Rath`,
          dep: '19:30',
          arr: '08:15',
          duration: '12h 45m',
          platform: 'PF 3',
        ...
        {
          id: '12409',
          name: `${fromShort} - ${toShort} Express`,
          dep: '21:00',
          arr: '11:30',
          duration: '14h 30m',
          platform: 'PF 4',
