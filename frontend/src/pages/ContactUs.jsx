...
export default function ContactUs() {
  const [messages, setMessages] = useState([
    { id: 1, sender: 'ai', text: "Welcome to IMXX Premium Support. I am your Digital Concierge. How may I assist you with your luxury travel arrangements today?" }
  ]);
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <h1 className="text-5xl md:text-6xl font-black text-white tracking-tighter mb-4">
            Digital <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-200 to-amber-500">Concierge</span>
          </h1>
          <p className="text-slate-400 font-medium tracking-wide max-w-2xl mx-auto">
            Connect directly with our elite support architects or query our intelligence engine for immediate assistance.
          </p>
        </div>
            ...
            <div className="bg-[#080c14]/80 backdrop-blur-2xl border border-slate-800/60 rounded-3xl p-8 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.8)] flex-1">
              ...
              <div className="space-y-8">
                <div className="flex items-start space-x-4 group cursor-pointer">
                  ...
                  <div>
                    <div className="text-[10px] text-slate-500 font-mono tracking-widest uppercase mb-1">Global Hotline</div>
                ...
                <div className="flex items-start space-x-4 group cursor-pointer">
                  ...
                  <div>
                    <div className="text-[10px] text-slate-500 font-mono tracking-widest uppercase mb-1">Priority Desk</div>
                ...
                <div className="flex items-start space-x-4 group cursor-pointer">
                  ...
                  <div>
                    <div className="text-[10px] text-slate-500 font-mono tracking-widest uppercase mb-1">Headquarters</div>
                    <div className="text-white font-bold tracking-wide">One World Trade Center<br/>Suite 8500, NY</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-8 bg-[#080c14]/80 backdrop-blur-2xl border border-slate-800/60 rounded-3xl shadow-[0_30px_60px_-15px_rgba(0,0,0,0.8)] flex flex-col overflow-hidden relative">
            ...
            <div className="h-20 border-b border-slate-800/60 flex items-center justify-between px-8 bg-[#020408]/50 relative z-10">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h3 className="text-white font-bold tracking-wide leading-tight">IMXX Intelligence</h3>
                  <div className="text-[10px] text-emerald-400 font-mono tracking-widest uppercase">Systems Online</div>
                </div>
              </div>
            </div>
              ...
              {messages.map((msg) => (
                <div key={msg.id} className={`flex ${msg.sender === 'user' ? 'justify-end' : 'justify-start'}`}>
                  <div className={`flex max-w-[80%] ${msg.sender === 'user' ? 'flex-row-reverse' : 'flex-row'} items-end`}>
                    ...
                    {/* Avatar */}
                    <div className={`shrink-0 w-8 h-8 rounded-full flex items-center justify-center mb-1
                      ${msg.sender === 'user' 
                        ? 'bg-slate-800 ml-3' 
                        : 'bg-gradient-to-br from-amber-200 to-amber-500 mr-3 shadow-[0_0_15px_rgba(245,158,11,0.3)]'}`}
                    >
                      {msg.sender === 'user' ? <User className="w-4 h-4 text-slate-400" /> : <Bot className="w-4 h-4 text-black" />}
                    </div>
                    ...
                    >
                      <p className="text-sm text-slate-200 leading-relaxed font-medium">{msg.text}</p>
                    </div>
