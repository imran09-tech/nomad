...
export default function WeatherTelemetryWidget({ colSpan = 4, className = '' }) {
  return (
    <AsymmetricBentoItem colSpan={colSpan} className={`p-6 bg-[#080c14] border border-slate-800/60 relative group overflow-hidden ${className}`}>
      <img 
      ...
      <div className="relative z-10 flex flex-col h-full justify-between">
        <div className="flex justify-between items-start mb-6">
          <div>
            <div className="text-[10px] text-slate-400 font-mono font-bold tracking-widest uppercase mb-1">Local Telemetry</div>
        ...
        <div className="grid grid-cols-2 gap-4 mt-auto">
          <div className="bg-[#020408]/80 backdrop-blur-sm rounded-xl p-3 border border-slate-800/40">
            ...
            <div className="text-[9px] text-slate-500 font-mono font-bold tracking-widest uppercase mt-1">Wind Speed</div>
          </div>
          <div className="bg-[#020408]/80 backdrop-blur-sm rounded-xl p-3 border border-slate-800/40">
            <Droplets className="w-4 h-4 text-slate-500 mb-2" />
            <div className="text-white font-bold tracking-wide">82%</div>
            <div className="text-[9px] text-slate-500 font-mono font-bold tracking-widest uppercase mt-1">Humidity</div>
          </div>
        </div>
      </div>
    </AsymmetricBentoItem>
