...
const mockTransitData = [
    // Trains
    { id: 'tr1', type: 'Train', operatorName: 'Eurostar', routeIdentifier: '9024', departureTime: '08:00', arrivalTime: '10:20', durationString: '2h 20m', pricingTier: 450 },
    { id: 'tr2', type: 'Train', operatorName: 'Venice Simplon', routeIdentifier: 'VS-1', departureTime: '08:00', arrivalTime: '20:00', durationString: '12h 00m', pricingTier: 3500 },
    { id: 'tr3', type: 'Train', operatorName: 'Shinkansen', routeIdentifier: 'NZomi-12', departureTime: '09:00', arrivalTime: '11:15', durationString: '2h 15m', pricingTier: 250 },
    { id: 'tr4', type: 'Train', operatorName: 'Blue Train', routeIdentifier: 'BT-ZA', departureTime: '15:00', arrivalTime: '22:00', durationString: '31h 00m', pricingTier: 2100 },
    
    // Buses
    { id: 'bu1', type: 'Bus', operatorName: 'Mahagama Bus Service', routeIdentifier: 'M-BG-01', departureTime: '08:00', arrivalTime: '09:45', durationString: '1h 45m', pricingTier: 2 },
    { id: 'bu2', type: 'Bus', operatorName: 'Mahagama Bus Service', routeIdentifier: 'M-GD-02', departureTime: '09:00', arrivalTime: '10:00', durationString: '1h 00m', pricingTier: 1 },
    { id: 'bu3', type: 'Bus', operatorName: 'Mahagama Bus Service', routeIdentifier: 'M-RN-03', departureTime: '20:00', arrivalTime: '04:30', durationString: '8h 30m', pricingTier: 15 },
    { id: 'bu4', type: 'Bus', operatorName: 'Luxury Coach', routeIdentifier: 'LC-NY-DC', departureTime: '08:00', arrivalTime: '12:30', durationString: '4h 30m', pricingTier: 120 },
];
...
function attachLiveTimestamps(data, requestedDate) {
    ...
    return data.map(item => {
        ...
        if (arrDate < depDate || item.durationString.includes('h') && parseInt(item.durationString) > 20) {
...
exports.searchTransit = async (req, res, next) => {
    try {
        ...
        const cacheKey = crypto.createHash('sha256').update(JSON.stringify({ originCity, destinationCity, departureDate })).digest('hex');
